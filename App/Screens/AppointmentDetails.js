...
const App = ({navigation, route}) => {
  ...
  const apiCalltransclist = async () => {
    ...
    formdata.append('booking_id', order_id);
    console.log('=====>', order_id);
    var response = await Helper.POST(Urls.booking_details_view, formdata);
      ...
      <FlatList
        ...
        renderItem={({item, index}) => (
          <View
            ...
            {/* ) : null} */}
            <Text
              style={[Style.text8, {color: Colors.blue, textAlign: 'center'}]}>
              {item.product_time_array.replace(',', '\n')}
            </Text>
          </View>
        )}
        keyExtractor={(item, index) => index.toString()}
            ...
            <View>
              ...
              <View style={{marginHorizontal: '5%', marginVertical: 10}}>
                <View style={{flexDirection: 'row', marginTop: 10}}>
                  <LText style={[Style.text12, {flex: 2}]}>Booking ID</LText>

                  <Text
                    style={[Style.text12, styles.con_brand, styles.textstyle]}>
                    {TRLIST?.booking_id}
                  </Text>
                </View>
                ...
                <View style={{flexDirection: 'row', marginTop: 10}}>
                  <LText style={[Style.text12, {flex: 2}]}>Service Name</LText>
                ...
                <View style={{flexDirection: 'row', marginTop: 10}}>
                  <LText style={[Style.text12, {flex: 2}]}>Total Points</LText>
                ...
                <View style={{flexDirection: 'row', marginTop: 10}}>
                  ...
                  <View
                    style={[Style.text12, styles.con_brand, styles.textstyle]}>
                    {validationempty(TRLIST.cart_extra_details)
                      ? list_date_time(TRLIST.cart_extra_details)
                      : null}
                  </View>
                </View>

                <View style={{flexDirection: 'row', marginTop: 10}}>
                  <LText style={[Style.text12, {flex: 2}]}>Comments</LText>
                ...
                <View style={{flexDirection: 'row', marginTop: 10}}>
                  <LText style={[Style.text12, {flex: 2}]}>Status</LText>
